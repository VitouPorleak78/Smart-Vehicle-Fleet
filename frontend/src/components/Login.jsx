...
export default function Login({ onLoginSuccess }) {
    ...
    const handleLoginSubmit = async (e) => {
        ...
        // 1. Role & Email domain validation
        ...
        try {
            ...
            if (response.ok) {
                ...
                if (onLoginSuccess) {
                    onLoginSuccess(role); // Transition to dashboard view
                }
            } else {
                    ...
                    <form onSubmit={handleLoginSubmit}>
                        ...
                        <div className="mb-5">
                            ...
                            <div className="relative flex items-center">
                                ...
                                />
                                <i 
                                    className={`fa-regular ${showPassword ? 'fa-eye-slash' : 'fa-eye'} absolute right-4 text-slate-400 cursor-pointer p-1 hover:text-slate-900`}
